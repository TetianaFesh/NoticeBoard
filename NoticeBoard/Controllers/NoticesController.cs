...
namespace NoticeBoard.Controllers
{
    public class NoticesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Date,UserId")] Notice notice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,Date,UserId")] Notice notice)
        {
            if (id != notice.Id)
            {
                return NotFound();
